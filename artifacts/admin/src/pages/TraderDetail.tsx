                        ...
                        <div className="flex items-start justify-between gap-3">
                          <div>
                            ...
                            {/* Team events: the Team tab is the readable view;
                                ...
                                metadata stays stored). Job-claim, reassignment,
                                removal-handover and member-quote events read
                                fine from their notes line, so their raw JSON
                                stays hidden too ("JOB" covers JOB_* and JOBS_*). */}
                            {e.details &&
                              Object.keys(e.details).length > 0 &&
                              !e.action.startsWith("MEMBER_") &&
                              !e.action.startsWith("JOB") &&
