...
const styles = StyleSheet.create({
  ...
  reviewCard: { backgroundColor: Colors.light.card, borderRadius: 12, padding: 16, marginBottom: 10, borderWidth: 1, borderColor: Colors.light.border, marginTop: 8 },
  ...
  replyBox: { marginTop: 10, padding: 12, borderRadius: 12, backgroundColor: Colors.light.primaryMuted },
