    ...
    >
      ...
      <View style={styles.section}>
        ...
        <Text style={styles.paragraph}>
          ...
          • Where Twilio Verify is configured, phone-number verification uses its configured channel, which may include SMS or RCS where available. Otherwise, the one-time code is sent to the trader's account email address. This is part of the trader verification checks and is never used for marketing.{'\n'}
