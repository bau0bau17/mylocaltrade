  ...
  return (
    ...
    >
      ...
      <View style={styles.section}>
        ...
        <Text style={styles.paragraph}>
          <Text style={styles.bold}>Payment provider:</Text> Trader subscriptions are purchased through the relevant app-store platform — Apple App Store for Apple purchases or Google Play where offered — and subscription status is managed by RevenueCat.
        </Text>
      </View>
      ...
      <View style={styles.section}>
        ...
        <Text style={styles.paragraph}>
          We use trusted third parties to deliver email (Brevo), store-managed subscriptions (the relevant app-store platform and RevenueCat) and hosting. These providers may set their own cookies under their own policies.
        </Text>
      </View>
