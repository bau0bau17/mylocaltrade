          ...
          {!otpSent ? (
            <View style={styles.card}>
              ...
              <Text style={styles.consentText}>
                By tapping 'Send verification code', you agree to receive a one-time verification message from MyLocalTrade. These messages are used only for account and phone verification, security and trust — never for marketing, advertising, promotions, discounts or bulk messaging. Message and data rates may apply. See our{' '}
