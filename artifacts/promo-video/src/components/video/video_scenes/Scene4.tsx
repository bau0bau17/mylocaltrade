  ...
  return (
    ...
    >
      <div className="w-1/2 h-full flex flex-col justify-center pl-[10vw]">
        <motion.div
          className="inline-block px-[1.5vw] py-[0.8vh] rounded-md bg-[#F59E0B]/20 text-[#F59E0B] font-bold text-[2vw] tracking-wider uppercase mb-[3vh]"
        ...
        <h2 
          className="text-[6.5vw] leading-[1.1] font-bold tracking-tight mb-[3vh]"
        ...
        <motion.p 
          className="text-[3vw] text-white/70 max-w-[38vw]"
          initial={{ opacity: 0 }}
      ...
      <div className="w-1/2 h-full relative flex items-center justify-center">
        ...
        >
          ...
          <div className="flex items-center space-x-[2vw] mb-[3vh]">
            ...
            <div>
              <h3 className="text-[2.8vw] font-bold">John's Plumbing</h3>
              <div className="flex items-center space-x-[0.5vw] text-[#F59E0B]">
                ...
                <span className="text-[1.9vw] font-semibold text-white">5.0 (124 reviews)</span>
              </div>
            </div>
          </div>
          ...
          <div className="space-y-[2vh]">
            <div className="flex justify-between items-center p-[2vh] bg-white/5 rounded-xl border border-white/5">
              <span className="text-[2.2vw] text-white/60">New Leads</span>
              <span className="text-[2.6vw] font-bold text-[#06D6A0]">+12 today</span>
            </div>
            <div className="flex justify-between items-center p-[2vh] bg-[#F59E0B]/10 rounded-xl border border-[#F59E0B]/30">
              <span className="text-[2.2vw] text-[#F59E0B] font-semibold">Featured Badge</span>
              <span className="text-[1.9vw] px-[1vw] py-[0.5vh] rounded-full bg-[#F59E0B] text-[#0B1120] font-bold">Active</span>
            </div>
          </div>
        </motion.div>
      </div>
