    ...
    >
      ...
      >
        ...
        <div className="flex items-center gap-[1.1vw]">
          ...
          <span
            className="text-[6vw] font-bold tracking-tighter leading-none text-white"
      ...
      <motion.p
        className="text-[3vw] font-medium text-white/80 tracking-wide text-center"
      ...
      >
        ...
        <div className="flex items-center gap-[1vw] px-[2vw] py-[1.4vh] rounded-[1vw] bg-black border border-white/25 shadow-[0_1vh_3vh_rgba(0,0,0,0.5)]">
          ...
          <div className="flex flex-col leading-none text-white text-left">
            <span className="text-[1.1vw] font-medium tracking-wide">Download on the</span>
            <span className="text-[2vw] font-semibold -mt-[0.3vh]">App Store</span>
          </div>
        </div>
      </motion.div>
