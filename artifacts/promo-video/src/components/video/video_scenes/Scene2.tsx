    ...
    >
      <div className="absolute inset-0 flex">
        ...
        <div className="w-[45%] h-full relative">
          ...
          >
            ...
            <div className="absolute bottom-0 left-0 right-0 p-[2vh] bg-gradient-to-t from-black/80 to-transparent">
              <p className="text-[2.5vw] font-semibold">Verified Plumbers</p>
            </div>
          </motion.div>
          ...
          >
            ...
            <div className="absolute bottom-0 left-0 right-0 p-[2vh] bg-gradient-to-t from-black/80 to-transparent">
              <p className="text-[2.5vw] font-semibold">Expert Electricians</p>
            </div>
          </motion.div>
          ...
          >
            ...
            <div className="absolute bottom-0 left-0 right-0 p-[2vh] bg-gradient-to-t from-black/80 to-transparent">
              <p className="text-[2.5vw] font-semibold">Trusted Painters</p>
            </div>
          </motion.div>
        </div>
        ...
        <div className="w-[55%] h-full flex flex-col justify-center pr-[10vw] pl-[5vw]">
          <h2 
            className="text-[6vw] leading-[1.1] font-bold tracking-tight mb-[4vh]"
          ...
          >
            ...
            <motion.span 
              className="block text-white/60 text-[4.2vw]"
              initial={{ opacity: 0, x: '5vw' }}
          ...
          <div className="space-y-[2vh]">
            {[
              ...
              >
                ...
                <span className="text-[3vw] font-medium text-white/90">{item.text}</span>
              </motion.div>
            ))}
          </div>
        </div>
