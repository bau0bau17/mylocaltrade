...
export const TRADER_AUDIT_ACTIONS = [
  ...
  "CONVERSATION_REPORT_CREATED",
  "USER_REPORT_RESOLVED",
  "USER_REPORT_CREATED",
  "REPORT_APPEAL_CREATED",
  "REPORT_APPEAL_RESOLVED",
  "CSEA_RESTRICTED_ESCALATION",
  "CSEA_RESTRICTED_COMPLETED",
  "AI_VERIFICATION_RAN",
  ...
  // An employee's account entered/finished the deletion lifecycle while they
