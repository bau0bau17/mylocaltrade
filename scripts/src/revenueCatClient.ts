 ...
 * OAuth access token from the Replit connectors service on every call (tokens
 * expire and are refreshed automatically), so the returned client must never be
 * cached. Integration: RevenueCat connector (ccfg_revenuecat).
 */
